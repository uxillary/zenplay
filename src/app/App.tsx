...
export const App = () => {
  ...
  const appClass = useMemo(() => {
    const classes = ['h-screen overflow-hidden p-4 md:p-6']
  ...
  return (
    <main className={appClass}>
      <div className="mx-auto grid h-full max-w-7xl grid-cols-1 gap-4 lg:grid-cols-[1fr_360px]">
        <section className="relative h-full rounded-3xl border border-zinc-600/60 bg-zinc-900/50 p-4">
          {screen === 'home' ? (
          ...
          {screen === 'solitaire' ? (
            <>
              <button type="button" onClick={() => setScreen('home')} className="mb-3 min-h-12 rounded-xl bg-zinc-700 px-4 text-lg">
                Back
              </button>
